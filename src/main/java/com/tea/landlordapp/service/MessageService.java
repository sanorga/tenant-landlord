...
public interface MessageService {
	...
	public boolean sendAnonymousUserMails(AnonymousUser anonymousUser, HttpServletRequest request) throws Exception;
	public boolean sendAnonymousUserMail(AnonymousUser anonymousUser, HttpServletRequest request, String destEmail)
			throws Exception;
