...
public class CustomLoginController {
	...
	@RequestMapping(value = "/landlordmain.htm", method = RequestMethod.GET)
	private String showLandlordMain(@RequestParam(value="message", required=false) String message,
			@RequestParam(value="email", required=false) String email,
			@RequestParam(value="reset", required=false) Boolean reset,
			Model model, HttpServletRequest request){
		if (StringUtils.isNotBlank(message)) {
	...
	@RequestMapping(value = "/rentermain.htm", method = RequestMethod.GET)
	private String showRenterMain(@RequestParam(value="message", required=false) String message,
			@RequestParam(value="email", required=false) String email,
			@RequestParam(value="reset", required=false) Boolean reset,
			Model model, HttpServletRequest request){
		if (StringUtils.isNotBlank(message)) {
