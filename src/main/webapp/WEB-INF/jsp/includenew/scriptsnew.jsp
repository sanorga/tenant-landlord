...
<c:if test="${zipChecker == true}">         <script src='js/zip2CityState.js'></script></c:if>
<c:if test="${activatePopUpWindow == true}"><script src='js/popupwindow.js'></script></c:if>
<c:if test="${activateQuickSearch == true}"><script src='js/quicksearch.js'></script></c:if>
<c:if test="${activateToolTips == true}">   <script src="js/qtip.js"></script></c:if>
<c:if test="${activateSearchTable == true}"><script src="js/searchtable.min.js"></script></c:if>
<c:if test="${moveApplications == true}">   <script src="js/searchtable_application.js"></script></c:if>
<c:if test="${blockUI == true}">            <script src="js/jquery.blockUI.js"></script></c:if>
<c:if test="${jqGrid == true}">             <script src="js/jqGrid.locale-EN.js"></script><script src="js/jquery.jqGrid.min.js"></script></c:if>

<c:if test="${numerFormat == true}">
  <script src="js/jquery.maskedinput.js"></script>
  <script src="js/jquery.numeric.only.js"></script>
  <script src="js/hashtable.js"></script>
  <script src="js/jquery.numberformatter.js"></script>
</c:if>

<c:if test="${kendoImport == true}"> 
  <script src="//da7xgjtj801h2.cloudfront.net/2014.2.716/js/kendo.core.min.js"></script>
  <script src="//da7xgjtj801h2.cloudfront.net/2014.2.716/js/kendo.userevents.min.js"></script>
  <script src="//da7xgjtj801h2.cloudfront.net/2014.2.716/js/kendo.draganddrop.min.js"></script>
  <script src="//da7xgjtj801h2.cloudfront.net/2014.2.716/js/kendo.window.min.js"></script>
</c:if>
